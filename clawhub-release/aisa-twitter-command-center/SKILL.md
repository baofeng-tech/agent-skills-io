...
description: Search X/Twitter profiles, tweets, trends, lists, communities, and Spaces through the AIsa relay. Use when: the user asks for Twitter research, monitoring, or approved posting without sharing passwords. Supports read APIs and OAuth-gated posting.
author: AIsa
version: "1.0.0"
license: Apache-2.0
user-invocable: true
...
- Preferred publish path: return the authorization link, then publish after approval
...
- This workflow does not require passwords, browser cookie extraction, direct account credential sharing, or home-directory persistence.
