...
description: Search X/Twitter profiles, tweets, trends, and approved engagement actions through the AIsa relay. Use when: the user asks for Twitter/X research, approved posting, likes, follows, or related workflows without sharing passwords. Supports read APIs, OAuth-gated posting, and engagement actions.
author: AIsa
version: "1.0.0"
license: Apache-2.0
user-invocable: true
...
- Return the authorization URL rather than attempting local browser launch from the published bundle.
...
- Do not attempt local browser launch from the published bundle.
