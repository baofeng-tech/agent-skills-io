...
- GitHub Actions 2026-05-08 复核：最新远程 run 仍是 `25460452313` 的失败，但该 run 使用旧 head/config；当前 `HEAD=4b0cbe6` 需要在本轮推送后再触发 current-HEAD validation run，不能把旧 run 当作当前修复已远程验证
