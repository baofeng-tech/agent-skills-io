...
def build_parser() -> argparse.ArgumentParser:
    ...
    like_tweet.add_argument("--tweet-id", required=True, help="Tweet ID resolved by prior agent context")
    ...
    unlike_tweet.add_argument("--tweet-id", required=True, help="Tweet ID resolved by prior agent context")
    ...
    follow_user_id.add_argument("--target-user-id", required=True, help="User ID resolved by prior agent context")
    ...
    unfollow_user_id.add_argument("--target-user-id", required=True, help="User ID resolved by prior agent context")
