...
- Bundle plugin id: `aisa-twitter-engagement-suite-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/aisa-twitter-engagement-suite/SKILL.md`
...
- Embedded skill path: `skills/aisa-twitter-engagement-suite/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:aisa-twitter-engagement-suite-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/aisa-twitter-engagement-suite-plugin --dry-run
clawhub package publish ./plugins/aisa-twitter-engagement-suite-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/aisa-twitter-engagement-suite/SKILL.md`.
