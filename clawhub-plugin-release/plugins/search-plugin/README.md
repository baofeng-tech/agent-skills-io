...
- Bundle plugin id: `search-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/search/SKILL.md`
...
- Embedded skill path: `skills/search/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:search-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/search-plugin --dry-run
clawhub package publish ./plugins/search-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/search/SKILL.md`.
