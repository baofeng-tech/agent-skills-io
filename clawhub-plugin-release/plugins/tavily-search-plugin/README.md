...
- Bundle plugin id: `tavily-search-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/tavily-search/SKILL.md`
...
- Embedded skill path: `skills/tavily-search/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:tavily-search-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/tavily-search-plugin --dry-run
clawhub package publish ./plugins/tavily-search-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/tavily-search/SKILL.md`.
