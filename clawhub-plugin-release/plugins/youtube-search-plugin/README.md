...
- Embedded skill: `skills/youtube-search/SKILL.md`
...
```bash
openclaw plugins install clawhub:youtube-search-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/youtube-search-plugin --dry-run
clawhub package publish ./plugins/youtube-search-plugin
```
