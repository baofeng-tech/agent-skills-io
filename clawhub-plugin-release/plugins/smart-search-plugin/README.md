...
- Bundle plugin id: `smart-search-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/smart-search/SKILL.md`
...
- Embedded skill path: `skills/smart-search/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:smart-search-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/smart-search-plugin --dry-run
clawhub package publish ./plugins/smart-search-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/smart-search/SKILL.md`.
