...
- Bundle plugin id: `aisa-twitter-command-center-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/aisa-twitter-command-center/SKILL.md`
...
- Embedded skill path: `skills/aisa-twitter-command-center/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:aisa-twitter-command-center-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/aisa-twitter-command-center-plugin --dry-run
clawhub package publish ./plugins/aisa-twitter-command-center-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/aisa-twitter-command-center/SKILL.md`.
