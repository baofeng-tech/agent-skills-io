...
- Bundle plugin id: `aisa-crypto-market-data-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/aisa-crypto-market-data/SKILL.md`
...
```bash
openclaw plugins install clawhub:aisa-crypto-market-data-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/aisa-crypto-market-data-plugin --dry-run
clawhub package publish ./plugins/aisa-crypto-market-data-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/aisa-crypto-market-data/SKILL.md`.
