...
- Bundle plugin id: `aisa-search-command-center-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/aisa-search-command-center/SKILL.md`
...
```bash
openclaw plugins install clawhub:aisa-search-command-center-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/aisa-search-command-center-plugin --dry-run
clawhub package publish ./plugins/aisa-search-command-center-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/aisa-search-command-center/SKILL.md`.
