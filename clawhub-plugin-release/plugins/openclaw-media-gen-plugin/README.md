...
- Bundle plugin id: `openclaw-media-gen-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/openclaw-media-gen/SKILL.md`
...
- Embedded skill path: `skills/openclaw-media-gen/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:openclaw-media-gen-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/openclaw-media-gen-plugin --dry-run
clawhub package publish ./plugins/openclaw-media-gen-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/openclaw-media-gen/SKILL.md`.
