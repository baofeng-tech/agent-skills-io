...
- Embedded skill path: `skills/openclaw-twitter/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:openclaw-twitter-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/openclaw-twitter-plugin --dry-run
clawhub package publish ./plugins/openclaw-twitter-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/openclaw-twitter/SKILL.md`.
