...
- Bundle plugin id: `perplexity-research-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/perplexity-research/SKILL.md`
...
- Embedded skill path: `skills/perplexity-research/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:perplexity-research-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/perplexity-research-plugin --dry-run
clawhub package publish ./plugins/perplexity-research-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/perplexity-research/SKILL.md`.
