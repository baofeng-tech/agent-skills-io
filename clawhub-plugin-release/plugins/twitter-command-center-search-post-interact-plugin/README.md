...
- Bundle plugin id: `twitter-command-center-search-post-interact-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/twitter-command-center-search-post-interact/SKILL.md`
...
- Embedded skill path: `skills/twitter-command-center-search-post-interact/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:twitter-command-center-search-post-interact-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/twitter-command-center-search-post-interact-plugin --dry-run
clawhub package publish ./plugins/twitter-command-center-search-post-interact-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/twitter-command-center-search-post-interact/SKILL.md`.
