...
- Bundle plugin id: `tavily-extract-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/tavily-extract/SKILL.md`
...
- Embedded skill path: `skills/tavily-extract/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:tavily-extract-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/tavily-extract-plugin --dry-run
clawhub package publish ./plugins/tavily-extract-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/tavily-extract/SKILL.md`.
