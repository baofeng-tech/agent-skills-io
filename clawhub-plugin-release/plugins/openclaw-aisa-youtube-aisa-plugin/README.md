...
- Embedded skill: `skills/openclaw-aisa-youtube-aisa/SKILL.md`
...
- Embedded skill path: `skills/openclaw-aisa-youtube-aisa/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:openclaw-aisa-youtube-aisa-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/openclaw-aisa-youtube-aisa-plugin --dry-run
clawhub package publish ./plugins/openclaw-aisa-youtube-aisa-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/openclaw-aisa-youtube-aisa/SKILL.md`.
