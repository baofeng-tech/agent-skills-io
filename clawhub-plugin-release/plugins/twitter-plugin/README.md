...
- Bundle plugin id: `twitter-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/twitter/SKILL.md`
...
- Embedded skill path: `skills/twitter/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:twitter-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/twitter-plugin --dry-run
clawhub package publish ./plugins/twitter-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/twitter/SKILL.md`.
