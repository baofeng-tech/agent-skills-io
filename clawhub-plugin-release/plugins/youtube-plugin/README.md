...
- Bundle plugin id: `youtube-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/youtube/SKILL.md`
...
- Embedded skill path: `skills/youtube/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:youtube-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/youtube-plugin --dry-run
clawhub package publish ./plugins/youtube-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/youtube/SKILL.md`.
