...
- Bundle plugin id: `aisa-tavily-search-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.js`
- Embedded skill: `skills/aisa-tavily-search/SKILL.md`
...
- Embedded skill path: `skills/aisa-tavily-search/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:aisa-tavily-search-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/aisa-tavily-search-plugin --dry-run
clawhub package publish ./plugins/aisa-tavily-search-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/aisa-tavily-search/SKILL.md`.
