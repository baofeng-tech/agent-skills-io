...
- Bundle plugin id: `aisa-youtube-serp-scout-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/aisa-youtube-serp-scout/SKILL.md`
...
- Embedded skill path: `skills/aisa-youtube-serp-scout/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:aisa-youtube-serp-scout-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/aisa-youtube-serp-scout-plugin --dry-run
clawhub package publish ./plugins/aisa-youtube-serp-scout-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/aisa-youtube-serp-scout/SKILL.md`.
