...
- Bundle plugin id: `stock-watchlist-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/stock-watchlist/SKILL.md`
...
- Embedded skill path: `skills/stock-watchlist/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:stock-watchlist-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/stock-watchlist-plugin --dry-run
clawhub package publish ./plugins/stock-watchlist-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/stock-watchlist/SKILL.md`.
