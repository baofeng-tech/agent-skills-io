...
- Bundle plugin id: `perplexity-search-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/perplexity-search/SKILL.md`
...
- Embedded skill path: `skills/perplexity-search/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:perplexity-search-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/perplexity-search-plugin --dry-run
clawhub package publish ./plugins/perplexity-search-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/perplexity-search/SKILL.md`.
