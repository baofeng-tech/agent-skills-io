...
- Bundle plugin id: `scholar-search-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/scholar-search/SKILL.md`
...
- Embedded skill path: `skills/scholar-search/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:scholar-search-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/scholar-search-plugin --dry-run
clawhub package publish ./plugins/scholar-search-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/scholar-search/SKILL.md`.
