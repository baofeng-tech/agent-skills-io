...
- Bundle plugin id: `aisa-twitter-post-engage-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/aisa-twitter-post-engage/SKILL.md`
...
- Embedded skill path: `skills/aisa-twitter-post-engage/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:aisa-twitter-post-engage-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/aisa-twitter-post-engage-plugin --dry-run
clawhub package publish ./plugins/aisa-twitter-post-engage-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/aisa-twitter-post-engage/SKILL.md`.
