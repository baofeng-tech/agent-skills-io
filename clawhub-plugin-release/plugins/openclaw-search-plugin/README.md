...
- Bundle plugin id: `openclaw-search-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/openclaw-search/SKILL.md`
...
- Embedded skill path: `skills/openclaw-search/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:openclaw-search-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/openclaw-search-plugin --dry-run
clawhub package publish ./plugins/openclaw-search-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/openclaw-search/SKILL.md`.
