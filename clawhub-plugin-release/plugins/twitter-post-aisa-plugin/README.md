...
- Bundle plugin id: `twitter-post-aisa-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.js`
- Embedded skill: `skills/twitter-post-aisa/SKILL.md`
...
- Embedded skill path: `skills/twitter-post-aisa/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:twitter-post-aisa-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/twitter-post-aisa-plugin --dry-run
clawhub package publish ./plugins/twitter-post-aisa-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/twitter-post-aisa/SKILL.md`.
