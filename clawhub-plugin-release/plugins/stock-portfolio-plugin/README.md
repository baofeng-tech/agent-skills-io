...
- Bundle plugin id: `stock-portfolio-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/stock-portfolio/SKILL.md`
...
- Embedded skill path: `skills/stock-portfolio/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:stock-portfolio-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/stock-portfolio-plugin --dry-run
clawhub package publish ./plugins/stock-portfolio-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/stock-portfolio/SKILL.md`.
