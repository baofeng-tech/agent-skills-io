...
- Bundle plugin id: `llm-router-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/llm-router/SKILL.md`
...
- Embedded skill path: `skills/llm-router/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:llm-router-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/llm-router-plugin --dry-run
clawhub package publish ./plugins/llm-router-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/llm-router/SKILL.md`.
