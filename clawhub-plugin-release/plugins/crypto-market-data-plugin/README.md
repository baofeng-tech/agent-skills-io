...
- Bundle plugin id: `crypto-market-data-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/crypto-market-data/SKILL.md`
...
- Embedded skill path: `skills/crypto-market-data/SKILL.md`
...
- Runtime requirements and guardrails remain inside `skills/crypto-market-data/SKILL.md`.
