...
- Bundle plugin id: `prediction-market-arbitrage-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/prediction-market-arbitrage/SKILL.md`
...
- Embedded skill path: `skills/prediction-market-arbitrage/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:prediction-market-arbitrage-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/prediction-market-arbitrage-plugin --dry-run
clawhub package publish ./plugins/prediction-market-arbitrage-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/prediction-market-arbitrage/SKILL.md`.
