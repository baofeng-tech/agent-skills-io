...
- Bundle plugin id: `x-intelligence-automation-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/x-intelligence-automation/SKILL.md`
...
- Embedded skill path: `skills/x-intelligence-automation/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:x-intelligence-automation-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/x-intelligence-automation-plugin --dry-run
clawhub package publish ./plugins/x-intelligence-automation-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/x-intelligence-automation/SKILL.md`.
