...
- Bundle plugin id: `web-search-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/web-search/SKILL.md`
...
- Embedded skill path: `skills/web-search/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:web-search-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/web-search-plugin --dry-run
clawhub package publish ./plugins/web-search-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/web-search/SKILL.md`.
