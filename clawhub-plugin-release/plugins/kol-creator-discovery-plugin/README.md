...
- Bundle plugin id: `kol-creator-discovery-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.js`
- Embedded skill: `skills/kol-creator-discovery/SKILL.md`
...
- Embedded skill path: `skills/kol-creator-discovery/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:kol-creator-discovery-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/kol-creator-discovery-plugin --dry-run
clawhub package publish ./plugins/kol-creator-discovery-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/kol-creator-discovery/SKILL.md`.
