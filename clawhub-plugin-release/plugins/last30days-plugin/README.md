...
- Network targets: `https://api.aisa.one, https://www.reddit.com, https://hacker-news.firebaseio.com, https://api.github.com, https://www.xiaohongshu.com`

## What It Ships

- Bundle plugin id: `last30days-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.js`
- Embedded skill: `skills/last30days/SKILL.md`
...
- Embedded skill path: `skills/last30days/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:last30days-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/last30days-plugin --dry-run
clawhub package publish ./plugins/last30days-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/last30days/SKILL.md`.
