...
- Bundle plugin id: `cn-llm-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/cn-llm/SKILL.md`
...
- Embedded skill path: `skills/cn-llm/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:cn-llm-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/cn-llm-plugin --dry-run
clawhub package publish ./plugins/cn-llm-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/cn-llm/SKILL.md`.
