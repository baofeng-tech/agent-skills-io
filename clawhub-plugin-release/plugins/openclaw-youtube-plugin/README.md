...
- Bundle plugin id: `openclaw-youtube-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/openclaw-youtube/SKILL.md`
...
- Embedded skill path: `skills/openclaw-youtube/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:openclaw-youtube-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/openclaw-youtube-plugin --dry-run
clawhub package publish ./plugins/openclaw-youtube-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/openclaw-youtube/SKILL.md`.
