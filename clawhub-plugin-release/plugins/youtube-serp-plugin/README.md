...
- Bundle plugin id: `youtube-serp-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/youtube-serp/SKILL.md`
...
- Embedded skill path: `skills/youtube-serp/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:youtube-serp-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/youtube-serp-plugin --dry-run
clawhub package publish ./plugins/youtube-serp-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/youtube-serp/SKILL.md`.
