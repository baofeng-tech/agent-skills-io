...
- Bundle plugin id: `us-stock-analyst-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/us-stock-analyst/SKILL.md`
...
- Embedded skill path: `skills/us-stock-analyst/SKILL.md`
...
- Runtime requirements and guardrails remain inside `skills/us-stock-analyst/SKILL.md`.
