...
- Bundle plugin id: `stock-hot-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/stock-hot/SKILL.md`
...
- Embedded skill path: `skills/stock-hot/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:stock-hot-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/stock-hot-plugin --dry-run
clawhub package publish ./plugins/stock-hot-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/stock-hot/SKILL.md`.
