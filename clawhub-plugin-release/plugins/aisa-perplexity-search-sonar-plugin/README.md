...
- Bundle plugin id: `aisa-perplexity-search-sonar-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/aisa-perplexity-search-sonar/SKILL.md`
...
```bash
openclaw plugins install clawhub:aisa-perplexity-search-sonar-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/aisa-perplexity-search-sonar-plugin --dry-run
clawhub package publish ./plugins/aisa-perplexity-search-sonar-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/aisa-perplexity-search-sonar/SKILL.md`.
