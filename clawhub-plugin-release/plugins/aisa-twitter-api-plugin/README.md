...
- Bundle plugin id: `aisa-twitter-api-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/aisa-twitter-api/SKILL.md`
...
- Embedded skill path: `skills/aisa-twitter-api/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:aisa-twitter-api-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/aisa-twitter-api-plugin --dry-run
clawhub package publish ./plugins/aisa-twitter-api-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/aisa-twitter-api/SKILL.md`.
