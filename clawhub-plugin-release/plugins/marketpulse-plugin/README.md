...
- Bundle plugin id: `marketpulse-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/marketpulse/SKILL.md`
...
- Embedded skill path: `skills/marketpulse/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:marketpulse-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/marketpulse-plugin --dry-run
clawhub package publish ./plugins/marketpulse-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/marketpulse/SKILL.md`.
