...
- Bundle plugin id: `multi-search-plugin`
- Native manifest: `openclaw.plugin.json`
- Native entrypoint: `index.ts`
- Embedded skill: `skills/multi-search/SKILL.md`
...
- Embedded skill path: `skills/multi-search/SKILL.md`
- The runtime behavior remains inside the packaged skill payload and its public docs.

## Install After Publishing

```bash
openclaw plugins install clawhub:multi-search-plugin
```

## Publish Locally

```bash
clawhub package publish ./plugins/multi-search-plugin --dry-run
clawhub package publish ./plugins/multi-search-plugin
```

## Notes

- Runtime requirements and guardrails remain inside `skills/multi-search/SKILL.md`.
