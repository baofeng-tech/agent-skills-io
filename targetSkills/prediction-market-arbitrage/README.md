...
This skill directory is focused on reading market data from platforms such as **Polymarket** and **Kalshi** through a unified API so agents can compare equivalent markets, inspect pricing differences, and check liquidity.
