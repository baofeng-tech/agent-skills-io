...
- Repository target: `https://github.com/baofeng-tech/agent-skills`
- Safety trim: removes plugin wrapper files from standard skill bundles.

## aisa-multi-search-engine

- Path: `agentskill-sh-release/aisa-multi-search-engine`
- Zip: `agentskill-sh-release/zips/aisa-multi-search-engine.zip`
...
- Path: `agentskill-sh-release/aisa-provider`
- Zip: `agentskill-sh-release/zips/aisa-provider.zip`
...
- Path: `agentskill-sh-release/aisa-tavily`
- Zip: `agentskill-sh-release/zips/aisa-tavily.zip`
...
- Path: `agentskill-sh-release/aisa-youtube-search`
- Zip: `agentskill-sh-release/zips/aisa-youtube-search.zip`
...
- Path: `agentskill-sh-release/aisa-youtube-serp-scout`
- Zip: `agentskill-sh-release/zips/aisa-youtube-serp-scout.zip`
...
- Path: `agentskill-sh-release/cn-llm`
- Zip: `agentskill-sh-release/zips/cn-llm.zip`
...
- Path: `agentskill-sh-release/gmail-lead-desk`
- Zip: `agentskill-sh-release/zips/gmail-lead-desk.zip`
...
- Path: `agentskill-sh-release/kol-creator-discovery`
- Zip: `agentskill-sh-release/zips/kol-creator-discovery.zip`
...
- Path: `agentskill-sh-release/last30days`
- Zip: `agentskill-sh-release/zips/last30days.zip`
...
- Path: `agentskill-sh-release/last30days-zh`
- Zip: `agentskill-sh-release/zips/last30days-zh.zip`
...
- Path: `agentskill-sh-release/llm-router`
- Zip: `agentskill-sh-release/zips/llm-router.zip`
...
- Path: `agentskill-sh-release/market`
- Zip: `agentskill-sh-release/zips/market.zip`
...
- Path: `agentskill-sh-release/multi-search`
- Zip: `agentskill-sh-release/zips/multi-search.zip`
...
- Path: `agentskill-sh-release/notion-workspace`
- Zip: `agentskill-sh-release/zips/notion-workspace.zip`
...
- Path: `agentskill-sh-release/openclaw-aisa-youtube-aisa`
- Zip: `agentskill-sh-release/zips/openclaw-aisa-youtube-aisa.zip`
...
- Path: `agentskill-sh-release/openclaw-media-gen`
- Zip: `agentskill-sh-release/zips/openclaw-media-gen.zip`
...
- Path: `agentskill-sh-release/openclaw-search`
- Zip: `agentskill-sh-release/zips/openclaw-search.zip`
...
- Path: `agentskill-sh-release/openclaw-twitter`
- Zip: `agentskill-sh-release/zips/openclaw-twitter.zip`
...
- Path: `agentskill-sh-release/openclaw-twitter-post-engage`
- Zip: `agentskill-sh-release/zips/openclaw-twitter-post-engage.zip`
...
- Path: `agentskill-sh-release/openclaw-youtube`
- Zip: `agentskill-sh-release/zips/openclaw-youtube.zip`
...
- Path: `agentskill-sh-release/perplexity-research`
- Zip: `agentskill-sh-release/zips/perplexity-research.zip`
...
- Path: `agentskill-sh-release/prediction-market`
- Zip: `agentskill-sh-release/zips/prediction-market.zip`
...
- Path: `agentskill-sh-release/prediction-market-arbitrage-api`
- Zip: `agentskill-sh-release/zips/prediction-market-arbitrage-api.zip`
...
- Path: `agentskill-sh-release/prediction-market-arbitrage-zh`
- Zip: `agentskill-sh-release/zips/prediction-market-arbitrage-zh.zip`
...
- Path: `agentskill-sh-release/prediction-market-data-zh`
- Zip: `agentskill-sh-release/zips/prediction-market-data-zh.zip`
...
- Path: `agentskill-sh-release/saas-gateway`
- Zip: `agentskill-sh-release/zips/saas-gateway.zip`
...
- Path: `agentskill-sh-release/scholar-search`
- Zip: `agentskill-sh-release/zips/scholar-search.zip`
...
- Path: `agentskill-sh-release/seo-keyword-research`
- Zip: `agentskill-sh-release/zips/seo-keyword-research.zip`
...
- Path: `agentskill-sh-release/smart-search`
- Zip: `agentskill-sh-release/zips/smart-search.zip`
...
- Path: `agentskill-sh-release/stock-analysis`
- Zip: `agentskill-sh-release/zips/stock-analysis.zip`
...
- Path: `agentskill-sh-release/stock-dividend`
- Zip: `agentskill-sh-release/zips/stock-dividend.zip`
...
- Path: `agentskill-sh-release/stock-hot`
- Zip: `agentskill-sh-release/zips/stock-hot.zip`
...
- Path: `agentskill-sh-release/stock-portfolio`
- Zip: `agentskill-sh-release/zips/stock-portfolio.zip`
...
- Path: `agentskill-sh-release/stock-rumors`
- Zip: `agentskill-sh-release/zips/stock-rumors.zip`
...
- Path: `agentskill-sh-release/stock-watchlist`
- Zip: `agentskill-sh-release/zips/stock-watchlist.zip`
...
- Path: `agentskill-sh-release/tavily-extract`
- Zip: `agentskill-sh-release/zips/tavily-extract.zip`
...
- Path: `agentskill-sh-release/tavily-search`
- Zip: `agentskill-sh-release/zips/tavily-search.zip`
...
- Path: `agentskill-sh-release/trend-forecast`
- Zip: `agentskill-sh-release/zips/trend-forecast.zip`
...
- Path: `agentskill-sh-release/twitter`
- Zip: `agentskill-sh-release/zips/twitter.zip`
...
- Path: `agentskill-sh-release/twitter-autopilot`
- Zip: `agentskill-sh-release/zips/twitter-autopilot.zip`
...
- Path: `agentskill-sh-release/twitter-command-center-search-post`
- Zip: `agentskill-sh-release/zips/twitter-command-center-search-post.zip`
...
- Path: `agentskill-sh-release/twitter-command-center-search-post-interact`
- Zip: `agentskill-sh-release/zips/twitter-command-center-search-post-interact.zip`
- Description: Searches and reads X (Twitter): profiles, timelines, mentions, followers, tweet search, trends, lists, communities, and Spaces. Publishes posts, likes/unlikes tweets, and follows/unfollows users after the user completes OAuth in the browser. Use when the user asks about Twitter/X data, social listening, posting, or interacting with tweets/users without sharing account passwords.

## us-stock-analyst

- Path: `agentskill-sh-release/us-stock-analyst`
- Zip: `agentskill-sh-release/zips/us-stock-analyst.zip`
...
- Path: `agentskill-sh-release/web-search`
- Zip: `agentskill-sh-release/zips/web-search.zip`
...
- Path: `agentskill-sh-release/x-intelligence-automation`
- Zip: `agentskill-sh-release/zips/x-intelligence-automation.zip`
- Description: Search X/Twitter profiles, tweets, trends, and approved engagement actions through the AIsa relay. Use when the user asks for Twitter/X research, posting, likes, follows, or related workflows without sharing passwords.

## youtube

- Path: `agentskill-sh-release/youtube`
- Zip: `agentskill-sh-release/zips/youtube.zip`
- Description: YouTube SERP Scout for agents. Search top-ranking videos, channels, and trends for content research and competitor tracking. Use when: the user needs YouTube search, trend discovery, channel research, or SERP analysis.

## youtube-search

- Path: `agentskill-sh-release/youtube-search`
- Zip: `agentskill-sh-release/zips/youtube-search.zip`
